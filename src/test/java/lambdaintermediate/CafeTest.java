...
class CafeTest {
    ...
    private Coffee ristretto;
    @BeforeEach
    public void initializeOrders() {
        espresso = new Coffee(CoffeeType.ESPRESSO, new BigDecimal(4.9));
        Coffee machiatto = new Coffee(CoffeeType.MACHIATTO, new BigDecimal(5.5));
        ristretto = new Coffee(CoffeeType.RISTRETTO, new BigDecimal(4.9));
    ...
    void addNewOrder() {
        ...
        cafe.addNewOrder(ristretto, espresso);

        assertEquals(new BigDecimal(9.8).setScale(2, RoundingMode.HALF_UP), cafe.getTotalIncome(LocalDate.now()));
