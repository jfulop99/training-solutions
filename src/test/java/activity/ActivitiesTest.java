...
class ActivitiesTest {
    ...
    void testAddActivity() {
        activities.addActivity(new ActivityWithoutTrack(ActivityType.BASKETBALL));

        int x = activities.numberOfWithoutTrackActivities();
        activities.addActivity(new ActivityWithoutTrack(ActivityType.BASKETBALL));
        assertEquals(x+1, activities.numberOfWithoutTrackActivities());
    }
